...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC                                                                                 // set by target:MCU_STM32G4
#define HSE_VALUE                                                             24000000                                                                                         // set by target:NUCLEO_G474RE
#define LPTICKER_DELAY_TICKS                                                  0                                                                                                // set by target:MCU_STM32G4
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                0                                                                                                // set by target:MCU_STM32G4
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:MCU_STM32G4
...
#define MBED_CONF_TARGET_LSE_DRIVE_LOAD_LEVEL                                 RCC_LSEDRIVE_LOW                                                                                 // set by target:MCU_STM32G4
